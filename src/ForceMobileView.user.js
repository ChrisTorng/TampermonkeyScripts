...
(function () {
    ...
    const MIN_FONT_EXCLUDED_URL_PREFIXES = [
        'https://github.com/nicolasahar/morphic-programming',
    ];
    ...
    function isAutoEnableExcludedForUrl() {
        return isUrlExcluded(window.location.href, AUTO_ENABLE_EXCLUDED_URL_PREFIXES);
    }

    function isMinFontExcludedForUrl() {
        return isUrlExcluded(window.location.href, MIN_FONT_EXCLUDED_URL_PREFIXES);
    }
