...
// @icon         https://www.google.com/s2/favicons?sz=64&domain=twitterwebviewer.com
    ...
    const redirectRules = [
        {
            ...
            buildTarget: (match) => `https://twitterwebviewer.com/?tweet=${match[2]}`,
            sessionKey: 'redirectx-last-redirect-x',
            skipReferrers: ['twitterwebviewer.com', 'twitter.com', 'x.com'],
