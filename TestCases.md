...
- https://ebird.org/atlastw/submit/checklist [CONTENT_CLASS: VALID_AUTH_REQUIRED] [TEST_STATUS: LIMITED] (species counts, field-activation behavior, uncommon-section expansion, breeding codes, heard comments, aggregate missing-field reporting, complete-list selection, and no-submit safety are automated with a local DOM harness)
