...
Section note: automated tests use representative inline code, math, Mastodon app markup, preformatted blocks, and mobile Wikipedia sections in the local DOM harness; live browser translation still requires manual validation.
- https://blog.plover.com/math/ordinals/02-wellfoundedness.html [CONTENT_CLASS: VALID_ARTICLE_CONTENT] [TEST_STATUS: AUTOMATED] (captured MathJax markup is detected; delimited source math remains the sole translation boundary so MathJax can render inside it without script interference, while MathJax previews remain untouched)
- https://hachyderm.io/@simontatham/117201594980991062 [CONTENT_CLASS: VALID_ARTICLE_CONTENT] [TEST_STATUS: AUTOMATED] (captured Mastodon app markup is detected and its page-wide notranslate class is removed without changing nested status content)
